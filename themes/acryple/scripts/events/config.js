...
hexo.extend.filter.register('before_generate', () => {
  ...
  const internalSrcCDN = {
    ...
    main: `https://imgs.luckynwa.top/jscss/hexo-theme-butterfly@${version}/main.min.js`,
    utils: `https://imgs.luckynwa.top/jscss/hexo-theme-butterfly@${version}/utils.min.js`,
    translate: `https://imgs.luckynwa.top/jscss/hexo-theme-butterfly@${version}/tw_cn.min.js`,
    local_search: `https://imgs.luckynwa.top/jscss/hexo-theme-butterfly@${version}/local-search.min.js`,
    algolia_js: `https://imgs.luckynwa.top/jscss/hexo-theme-butterfly@${version}/algolia.min.js`,
  }
  ...
  const thirdPartySrcCDN = {
    ...
    sharejs_css: 'https://imgs.luckynwa.top/jscss/fontcss/share.min.css',
