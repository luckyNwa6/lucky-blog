...
function todis() {
  $.ajax({
    type: 'get',
    url: 'https://apis.map.qq.com/ws/location/v1/ip', //wx扫下面
    data: {
    ...
    success: function (res) {
      // console.log('当前地址ip：', res)//腾讯地图ip查询
      ipLoacation = res
      ...
      function showWelcome() {
        ...
        document.getElementsByClassName('announcement_content')[0].innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>
        你距离LuckyNwa约有<span>${dist}</span>公里，${posdesc}
        <br>
        <br>
