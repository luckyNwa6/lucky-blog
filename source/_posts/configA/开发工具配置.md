...
![img](http://luckynwa.top/mypic/mdS/2fc4d2d3139d44cd9e9d4dbed7477d55.png)
...
![img](http://luckynwa.top/mypic/mdS/beb3718241de46edb65d6318bb41cc8d.png)

## 滚轮设置编辑区字体大小

General 临时生效，第二次进入，又变回去

![img](http://luckynwa.top/mypic/mdS/716b4cb25e7846b183789a8fe9929f37.png)
...
![img](http://luckynwa.top/mypic/mdS/b6b87225fce343e581a931e8598e7fa8.png)

## 显示行号和方法的分隔符

File | Settings | Editor | General | Appearance

![img](http://luckynwa.top/mypic/mdS/901142a1dfc5430eb280aff4f1bd0ca7.png)

## **设置鼠标悬浮提示**

File | Settings | Editor | General | Code Completion 勾选显示标题功能

![img](http://luckynwa.top/mypic/mdS/0fe541133367443db67f435fa38b4f09.png)

## **忽略字母大小写的提示**

File | Settings | Editor | General | Code Completion 取消勾选

![img](http://luckynwa.top/mypic/mdS/e6c08d5733cd4b65ab0678fdebf07a07.png)

## 设置编码

Encodings 影响 i18n 里中文，必配，那个勾选也记得

![img](http://luckynwa.top/mypic/mdS/63b5b37ebdec4731b6c8378569275851.png)
...
![img](http://luckynwa.top/mypic/mdS/5fe98091ba9246ee8f48156bfcc16687.png)

## 设置字体、字体大小、行间距

File | Settings | Editor | Font

![img](http://luckynwa.top/mypic/mdS/85de093acf034b0da65581b18c330e06.png)
